                    ...
                    <form action="{{ route('courses.store') }}" method="POST" class="space-y-4">
                        ...
                        <div class="grid gap-4 md:grid-cols-3">
                            ...
                            <div class="md:col-span-2">
                                ...
                                <textarea name="course_description" rows="1" placeholder="Enter course description"
                                          class="w-full rounded-lg border border-neutral-300 bg-white px-4 py-2 text-sm focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-500/20 dark:border-neutral-600 dark:bg-neutral-800 dark:text-neutral-100">{{ old('course_description') }}</textarea>
                        ...
                        <div class="flex justify-end">
                            <button type="submit" class="rounded-lg bg-blue-600 px-6 py-2 text-sm font-medium text-black border border-black cursor-pointer transition-colors hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500/20">
                                Add Course
                            </button>
                        </div>
                    </form>
                                ...
                                @forelse($courses as $course)
                                    <tr class="transition-colors hover:bg-neutral-50 dark:hover:bg-neutral-800/50" id="course-row-{{ $course->id }}">
                                        ...
                                        <td class="px-4 py-3 text-center text-sm text-neutral-600 dark:text-neutral-400">
                                            <span class="course-description-display">{{ Str::limit($course->course_description, 50) ?? 'N/A' }}</span>
                                        </td>
                                        <td class="px-4 py-3 text-center text-sm">
                                            <button onclick="editCourse({{ $course->id }}, '{{ $course->course_name }}', '{{ addslashes($course->course_description) }}')"
        ...
        <div class="w-full max-w-2xl rounded-xl border border-neutral-200 bg-white p-6 dark:border-neutral-700 dark:bg-neutral-800">
            ...
            <form id="editCourseForm" method="POST">
                ...
                <div class="grid gap-4 md:grid-cols-2">
                    ...
                    <div class="md:col-span-2">
                        <label class="mb-2 block text-sm font-medium text-neutral-700 dark:text-neutral-300">Description</label>
                        <textarea id="edit_course_description" name="course_description" rows="3"
